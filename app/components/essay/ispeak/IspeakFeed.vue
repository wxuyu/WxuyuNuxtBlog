...
import Ispeak_Body from './IspeakBody.vue'
import type { SpeakType, TagType } from '~/data/essay/ispeak/ispeakTypes'
import blogConfig from '~~/blog.config'
import appConfig from '~/app.config'

const userConfig = {
  author: appConfig.essay.CONFIG.ISPEAK_CONFIG.author,
  pageSize: '20'
}
/**
 * loading状态标识
...
const getSpeakData = async () => {
  const url = appConfig.essay.API.ISPEAK
  try {
    loading.value = false
    /**
     *  author: userConfig.author,
